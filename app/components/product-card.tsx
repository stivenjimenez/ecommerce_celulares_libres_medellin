...
export function ProductCard({
  ...
  const handlePointerMove = (event: React.PointerEvent<HTMLDivElement>) => {
    ...
    const limitedDelta = atFirst || atLast ? deltaX * 0.35 : deltaX;
    ...
    >
      <div
        ...
        onPointerEnter={(event) => {
          if (hoverImage && event.pointerType === "mouse") {
      ...
      >
        ...
        {hoverImage ? (
          <div
            className={`${styles.desktopHoverImage} ${hoverPreview ? styles.desktopHoverImageVisible : ""}`}
          >
            <Image
              src={hoverImage}
              alt=""
